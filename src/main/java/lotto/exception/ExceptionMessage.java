...
public enum ExceptionMessage {
    ...
    INVALID_LOTTO_NUMBERS_COUNT("당첨 번호는 6개로 입력해 주세요."),
    INVALID_LOTTO_NUMBER_RANGE("번호는 1~45의 범위로 입력해 주세요."),
    INVALID_DUPLICATE_LOTTO_NUMBER("로또 번호는 중복 없이 입력해 주세요."),
    INVALID_DUPLICATE_BONUS_NUMBER("보너스 번호는 당첨 번호와 중복 없이 입력해 주세요."),
    ;
